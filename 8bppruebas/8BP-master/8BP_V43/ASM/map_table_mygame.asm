...
MAX_SP_WIDTH 	dw -100;-20; ancho maximo de cualquier map item. debe expresarse como numero negativo
MAPITEMS db 19; numero de elementos del mapa a considerar. como mucho debe ser 82
