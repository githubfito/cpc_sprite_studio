...
;mini_BASIC/minibasic.h:186: buffer[i++] = 48 + r ;
	...
	inc	hl
	ex	(sp), hl
	ld	a, #<(__basic_str_buffer_65536_273)
	ld	hl, #2
	add	hl, sp
	add	a, c
	ld	(hl), a
...
; ---------------------------------
_main::
;ciclo.c:9: _basic_print("hola");
	ld	hl, #___str_1
	push	hl
	call	__basic_print
	pop	af
;ciclo.c:10: _8BP_setupsp_3(0,1,1);
	ld	hl, #0x0001
	push	hl
	ld	l, #0x01
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:11: _8BP_setupsp_3(0,9,16);
	ld	hl, #0x0010
	push	hl
	ld	l, #0x09
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:12: _8BP_locatesp_3(0,20,20);
	ld	hl, #0x0014
	push	hl
	ld	l, #0x14
	push	hl
