...
function generateCPCDisk(screenData, mode) {
    const TRACKS = 40;
    const SECTORS = 9;
    ...
    const loaderBasicStr = `10 MODE ${mode}\r\n20 LOAD "SCREEN.BIN",&C000\r\n30 CALL &BB18\r\n\x1A`;
    ...
    const headerBin = createAmsdosHeader("SCREEN  ", "BIN", 2, screenData.length, 0xC000, 0x0000);
