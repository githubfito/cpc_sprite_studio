...
function generateCPCDisk(screenData, mode, animate, fw, fh, nf) {
    ...
    // --- LOADER BASIC (LIMPIO Y SIN ERRORES DE SINTAXIS) ---
    ...
    if (!animate) {
        ...
        loaderBasicStr = 
            ...
            "40 FOR i=0 TO 20: READ a: POKE &A000+i, a: NEXT i\r\n" +
            "50 DATA 221,110,4,221,102,5,221,94,2,221,86,3,221,78,0,221,70,1,237,176,201\r\n" +
