...
function generateCPCDisk(screenData, mode, animate, fw, fh, nf) {
    ...
    // --- LOADER BASIC (CON CÁLCULO DE VRAM EN ASM) ---
    ...
    if (!animate) {
        ...
        loaderBasicStr = 
            ...
            "40 FOR i=0 TO 50: READ a: POKE &A000+i, a: NEXT i\r\n" +
            "45 DATA 221,126,2,230,7,7,7,7,246,192,87,30,0,221,126,2,203,63,203,63\r\n" +
            "50 DATA 203,63,111,38,0,41,41,41,41,229,41,41,193,9,25,235,221,110,4,221\r\n" +
            "55 DATA 102,5,221,78,0,221,70,1,237,176,201\r\n" +
            "60 f=0: w=" + wBytes + ": h=" + fh + ": nf=" + nf + "\r\n" +
            "70 PRINT \"ANCHO:\";w;\" ALTO:\";h;\" NF:\";nf\r\n" + 
            "80 WHILE 1\r\n" +
            "90 FOR y=0 TO h-1\r\n" +
            "100 s = &4000 + (f * w * h) + (y * w)\r\n" +
            "110 CALL &A000, s, y, w\r\n" +
            "120 NEXT y\r\n" +
            "130 CALL &BD19\r\n" +
            "140 f = (f + 1) MOD nf\r\n" +
